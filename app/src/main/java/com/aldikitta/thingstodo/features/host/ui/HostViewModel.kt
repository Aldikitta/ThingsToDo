...
//
//@HiltViewModel
//class HostViewModel @Inject constructor(hostEnvironmentRepository: HostEnvironmentRepository) :
//    StatefulViewModel<HostState, Unit, Unit, HostEnvironmentRepository>(HostState(), hostEnvironmentRepository) {
//    init {
//        initTheme()
//    }
//
