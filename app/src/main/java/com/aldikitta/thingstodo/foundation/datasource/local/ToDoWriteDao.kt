...
import com.aldikitta.thingstodo.model.ToDoRepeat
...
abstract class ToDoWriteDao {
    ...
    abstract suspend fun updateListNameAndColor(
        id: String,
        name: String,
        color: ToDoColor,
    ...
    abstract suspend fun updateListGroup(
        ids: List<String>,
        groupId: String,
        updatedAt: LocalDateTime
    )
    ...
    abstract suspend fun updateTaskDueDate(
        id: String,
    ...
    abstract suspend fun resetTaskDueDate(
        id: String,
        dueDate: LocalDateTime?,
        isDueDateTimeSet: Boolean,
        repeat: ToDoRepeat,
