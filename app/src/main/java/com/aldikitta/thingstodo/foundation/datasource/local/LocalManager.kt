...
import com.aldikitta.thingstodo.foundation.extension.*
...
class LocalManager @Inject constructor(
    ...
    suspend fun updateGroupName(id: String, name: String, updateAt: LocalDateTime) {
        withContext(dispatcher) {
            toDoWriteDao.updateGroupName(id, name, updateAt)
        }
    }
